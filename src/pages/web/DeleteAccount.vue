    ...
    <div class="container">
      ...
      <div class="warning-section">
        ...
        <div class="warning-content">
          <h3 class="text-h6 text-negative q-mb-sm">
      ...
      <div class="form-section">
        ...
        <p class="text-body2 text-grey-7 q-mb-lg">
          Please enter your email and password to confirm the deletion of your
          account.
        </p>
    ...
    <q-dialog v-model="showFinalConfirmation" persistent>
      <q-card style="min-width: 350px">
        ...
        <q-card-actions align="right">
          <q-btn flat label="Cancel" @click="showFinalConfirmation = false" />
          <q-btn
            flat
  ...
  try {
    ...
    if (
      ...
      errorMessages.value.email =
        "Email not found or doesn't match your account.";
